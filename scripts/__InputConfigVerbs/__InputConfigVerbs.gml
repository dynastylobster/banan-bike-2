function __InputConfigVerbs()
{
    ...
    if (not INPUT_ON_SWITCH)
    {
		...
		InputDefineVerb(INPUT_VERB.BUMPL,   "bumpl",       ["Q"],          gp_shoulderlb);
		InputDefineVerb(INPUT_VERB.BUMPR,   "bumpl",       ["E"],          gp_shoulderrb);
		InputDefineVerb(INPUT_VERB.TRIGL,   "trigl",       ["1"],          gp_shoulderl);
		InputDefineVerb(INPUT_VERB.TRIGR,   "trigr",       ["3"],          gp_shoulderr);		
    }
    else //Flip A/B over on Switch
    {
		...
		InputDefineVerb(INPUT_VERB.BUMPL,   "bumpl",   undefined,          gp_shoulderlb);
		InputDefineVerb(INPUT_VERB.BUMPR,   "bumpl",    undefined,          gp_shoulderrb);
		InputDefineVerb(INPUT_VERB.TRIGL,   "trigl",    undefined,          gp_shoulderl);
		InputDefineVerb(INPUT_VERB.TRIGR,   "trigr",    undefined,          gp_shoulderr);	
    }
